...
class Backend extends Controller
{
    ...
    public function _initialize()
    {
        ...
        // Reset the connection context on every request; never take an actor from request input.
        \think\Db::execute('SET @creator_audit_actor = ?', [$this->auth->isLogin() ? 'app-admin:'.(int)$this->auth->id : null]);
...
//            $this->model->field('id,username as name'); // 指定显示字段
